...
export function AboutUsPage() {
  return (
    <div>
      ...
      <p>
        Bold Studio is a leading web development company, <br />
        specializing in the creation of websites with focus on both
        <br />
        ...
        robust and efficient technical infrastructure.{" "}
      </p>
      <SocialMedia />
    </div>
  );
